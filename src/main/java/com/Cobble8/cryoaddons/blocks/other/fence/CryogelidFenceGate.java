...
public class CryogelidFenceGate extends BlockHorizontal implements IHasModel
{
	...
	public CryogelidFenceGate(String name, float hardness, SoundType sound, float resistance) 
	{
		super(Material.WOOD);
