...
public class ContainerCryosteelGenerator extends Container
{
	private final TileEntityCryosteelGenerator tileentity;
	private int energy, cookTime;
	
	public ContainerCryosteelGenerator(InventoryPlayer player, TileEntityCryosteelGenerator tileentity) 
	{
		this.tileentity = tileentity;
		IItemHandler handler = tileentity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null);
		
		this.addSlotToContainer(new SlotItemHandler(handler, 0, 80, 38));
