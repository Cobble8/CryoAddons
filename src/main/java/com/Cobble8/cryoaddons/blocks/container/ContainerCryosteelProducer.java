...
public class ContainerCryosteelProducer extends Container
{
	private final TileEntityCryosteelProducer tileentity;
	private int energy, cookTime;
	
	public ContainerCryosteelProducer(InventoryPlayer player, TileEntityCryosteelProducer tileentity) 
	{
		this.tileentity = tileentity;
		IItemHandler handler = tileentity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null);
		
		this.addSlotToContainer(new SlotItemHandler(handler, 0, 80, 32));
