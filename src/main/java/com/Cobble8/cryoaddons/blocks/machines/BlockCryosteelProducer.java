...
public class BlockCryosteelProducer extends BlockBase 
{
	//public static final PropertyDirection FACING = BlockHorizontal.FACING;
		
	public BlockCryosteelProducer(String name) 
	{
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(Main.instance, ConfigHandler.GUI_CRYOSTEEL_PRODUCER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	{
		return new TileEntityCryosteelProducer();
	}
	...
	{
		TileEntityCryosteelProducer tileentity = (TileEntityCryosteelProducer)worldIn.getTileEntity(pos);
