...
import com.Cobble8.cryoaddons.init.ModSounds;
...
public class GUICryoAddonsGuide extends GuiScreen {
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/book_pages/cryoaddons_guide_page_blank.png");
    ...
    //Textures
    private static final ResourceLocation CRYOSTEEL_ORE_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/cryosteel_ore.png");
    private static final ResourceLocation CRYOSTEEL_INGOT_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/items/cryosteel_ingot.png");
    private static final ResourceLocation CRYOSTEEL_BLOCK_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/cryosteel_block.png");
    
    
	
	public GUICryoAddonsGuide(ItemStack heldItem) {
		this.stack = heldItem;
	}
	...
	public void drawScreen(int parX, int parY, float partial) {
		...
		/*
		if(pageNum == 0) {
		     fr.drawString("", GUIxCoord + 15, GUIyCoord + 16,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 28,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 40,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 52,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 64,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 76,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 88,  14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 100, 14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 112, 14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 124, 14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 136, 14489, false);
			 fr.drawString("", GUIxCoord + 15, GUIyCoord + 148, 14489, false);
		...
		//Page 2
			...
			fr.drawString("", GUIxCoord + 900000, GUIyCoord + 900000, 16777215, false);
			 ...
			 manager.bindTexture(CRYOSTEEL_ORE_TEXTURE);
			 this.drawModalRectWithCustomSizedTexture(GUIxCoord+20, GUIyCoord+17,0F,1F,30,30,30,30);
			 
			 manager.bindTexture(CRYOSTEEL_INGOT_TEXTURE);
			 this.drawModalRectWithCustomSizedTexture(GUIxCoord+90,GUIyCoord+129,0F,1F,32,32,32,32);
		}
		if(pageNum == 3) {
			 ...
			 manager.bindTexture(CRYOSTEEL_INGOT_TEXTURE);
			 this.drawModalRectWithCustomSizedTexture(GUIxCoord+19,GUIyCoord+17,0F,1F,32,32,32,32);
			 
			 manager.bindTexture(CRYOSTEEL_BLOCK_TEXTURE);
			 this.drawModalRectWithCustomSizedTexture(GUIxCoord+91,GUIyCoord+129,0F,1F,30,30,30,30);
		}
